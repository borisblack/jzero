...
typedef void (*htable_foreach_func) (const HTableNode* node, void *arg, void *local_arg);
...
/* Iterates over items */
extern void htable_foreach(HTable* tbl, htable_foreach_func func, void *local_arg);
