...
void semantic(Tree *root) {
  ...
  symtab_InsertEntry(out_st, "println", false, NULL, (TypeInfo*)typeinfo_CreateMethodType(NULL, 0, NULL));
  symtab_InsertEntry(System_st, "out", false, out_st, (TypeInfo*)typeinfo_CreateClassType("PrintStream", out_st));
  symtab_InsertEntry(global_st, "System", false, System_st, (TypeInfo*)typeinfo_CreateClassType("System", System_st));
